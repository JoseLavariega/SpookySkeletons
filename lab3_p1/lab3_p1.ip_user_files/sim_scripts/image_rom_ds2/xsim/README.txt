...
#
# Generated by export_simulation on Wed Sep 29 21:43:44 EDT 2021
#
################################################################################
...
'-reset_run' switch to the './image_rom_ds2.sh' script.

./image_rom_ds2.sh -reset_run
...
./image_rom_ds2.sh -noclean_files

For more information on the script, please type './image_rom_ds2.sh -help'.
