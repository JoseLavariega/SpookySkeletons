...
module fir31_test();
  ...
  initial begin
    ...
    fin = $fopen("/home/joselavariega/Desktop/6.111 Digital Systems Lab/lab_5_6111/fir31.impulse","r");
    fout = $fopen("fir31.output","w");
    if (fin == 0 || fout == 0) begin
      $display("can't open file...");
      $stop;
    end
//file:///home/joselavariega/Desktop/6.111%20Digital%20Systems%20Lab/lab_5_6111/fir31.waveform
